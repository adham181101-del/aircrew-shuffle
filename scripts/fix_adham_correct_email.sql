-- Fix script for correct staff assignments with Adham's correct email
-- Staff Number 1234567890 = Shaheen (shaheenamin09@ba.com)
-- Staff Number 254575 = Adham (adham.fati.el.hamzaouy@ba.com)
...
-- 254575 should be Adham with correct email
UPDATE public.staff 
