-- Quick check to see if test staff exist and their availability
...
-- Check who is OFF on 2025-01-20 (should be Mike)
...
-- Check who is OFF on 2025-01-21 (should be Jane and Sarah)
