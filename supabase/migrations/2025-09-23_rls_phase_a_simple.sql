-- RLS Phase A: Simple, working migration
-- This migration adds basic RLS without complex conditional logic
...
-- Note: We'll add subscription indexes and user_id policies in a separate migration
-- once we confirm the subscriptions table structure
