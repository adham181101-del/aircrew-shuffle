-- RLS Phase A: Non-breaking security improvements (FIXED VERSION)
...
-- Create function to enforce user_id immutability
...
-- User-scoped subscription policies
...
-- 4. Create indexes for performance (removed CONCURRENTLY and transaction wrapper)
